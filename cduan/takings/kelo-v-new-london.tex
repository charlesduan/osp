\reading{Kelo v. City of New London, Conn.}
...
%Park now occupies 18 of those 32 acres).
...
%by public walkway to the remainder of the development, including the state
%park.
...
%final stretch of the riverwalk. Parcels 5, 6, and 7 will provide land for
%office
%and retail space, parking, and water-dependent commercial uses. 

The [plan's creators] intended the development plan to capitalize on the arrival
of the
...
%\textit{Berman v. Parker}, 348 U.S. 26 (1954), the court held that such
%economic
...
%necessary'' to achieving the City's intended public use and, second, whether
%the
...
% Reaffirming \textit{Berman's} deferential approach to
%legislative judgments in this field, we concluded that the State's purpose of
%eliminating the ``social and economic evils of a land oligopoly'' qualified as
%a
...
%
%\ldots Where is the line between ``public'' and ``private'' property use?
We
...
%property use,
[T]he Court today significantly expands the meaning of public use.
