...
%Carolina Legislature to effectuate those purposes.
%The South Carolina Supreme Court, however, thought otherwise. In its view,
...
%his land might occasion
%[and] within a long line of this Court's cases
...
[The South Carolina Supreme Court concluded that there had been no taking, on
the grounds that the beachfront legislation was a valid exercise of the state's
police powers to prevent public harm. The U.S. Supreme Court rejected this
argument on two grounds. First, said the Court, the principle that
harm-prevention legislation was permissible under the Takings Clause was
outdated in the case law. Second:]
...
%decides the present case.\ldots
%The ``harmful or noxious uses'' principle was the
...
estate.\ldots
% A given restraint will be seen as mitigating ``harm'' to the adjacent
...
%compensation) \textit{any} regulatory diminution in value; and that
[T]he
...
objective, value-free basis\ldots.
%, it becomes self-evident that noxious-use logic
...
%compensation.
%\textit{A fortiori}
%The legislature's recitation of a noxious-use
