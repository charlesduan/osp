...
This section provides a brief overview of some of those justifications. \emph{Be
aware that these are not legal rules, and you should not apply them directly, on
an exam or otherwise.} Instead, these theoretical considerations will help you
understand the ``why'' behind the rules, and behind property law generally.
And they will give you a vocabulary for arguing for or against rules and
outcomes, especially when there is ambiguity about how a rule will apply to
certain facts.
Consider which of these theories resonate with you, which you would take issue
with, and which strike you as new and unexpected.
...
\defbook{murphy-nagel-myth-ownership}{
...
For that matter, in a complex modern society, can anyone truly say that they
deserve sole credit for, and thus sole ownership over, their labor?
\begin{quote}
We are all born into an elaborately structured legal system governing the
acquisition, exchange, and transmission of property rights, and ownership comes
to seem the most natural thing in the world. But the modern economy in which we
earn our salaries, own our homes, bank accounts, retirement savings and personal
possessions, and in which we can use our resources to consume or invest, would
be impossible without the framework provided by government supported by
taxes.\ldots We cannot start by taking as given, and neither in need of
justification nor subject to critical evaluation, some initial allocation of
possessions---what people originally own, what is theirs, prior to government
interference.
\end{quote}
\sentence{murphy-nagel-myth-ownership at 8}.
...
\label{flutes-efficient-allocation}

Say that there there are a couple of fine flutes, and somewhere out there are a
few brilliant flutists. How will the flutes get to the right people? One
answer is to have the government hold a big talent contest and award the flutes
to the best players. That would be expensive and
time-consuming. And who should judge the ``best flutists''?
...
\paragraph{Critiquing the justifications: Tax policy}
The perspectives thus far have painted a rosy picture of property ownership. But
often, the institution of property conflicts with other societal interests,
suggesting that the rights of property ownership should be limited and not
absolute. In a certain sense, almost everything in property law is about
balancing ownership rights against other interests. (Otherwise, this textbook
would be much shorter.) And many broad areas of law, such as antitrust or
environmental law, further develop the limits of property.

At this initial juncture, though, can you identify some critiques of the
justifications for property given above? A useful starting point is the theory
of taxation. You might think of taxes as the government taking a portion of
people's property to fund various social goals. Alternatively,
\inline{murphy-nagel-myth-ownership} posit that an entitlement to property only
inheres after taxes are determined:
\begin{quote}
[T]here are no property rights antecedent to the tax structure. Property rights
are the product of a set of laws and conventions, of which the tax system forms
a part. Pretax income, in particular, has no independent moral significance. It
does not define something to which the taxpayer has a prepolitical or natural
right, and which the government expropriates from the individual in levying
taxes on it. All the normative questions about what taxes are justified and what
taxes are unjustified should be interpreted instead as questions about how the
system should define those property rights\ldots.
\end{quote}
\sentence{murphy-nagel-myth-ownership at 74}. Either way, the implication is
that a justification for taxation may also be a reason to limit property rights.
Here are some justifications for taxation:
\begin{itemize}
\item Fairness in shouldering the costs of operating an effective government,
based on either individuals' ability to pay (those who can afford to pay more
ought to) or receipt of government benefits (those who receive more benefits
should pay more).
\item Provision of public goods, such as roads, public parks, and national
defense.
\item Enhancing overall societal efficiency and welfare (utilitarianism).
\item Promoting distributive justice, namely the rectification of economic
inequalities that stem from morally arbitrary differences between people.
\item Enabling equality of opportunity by ensuring that everyone has a baseline
of resources to meet basic needs.
\end{itemize}
\sentence{murphy-nagel-myth-ownership at 12-75}. Can you translate these points
into arguments for limiting property ownership? Can you come up with further
critiques of your own? And how do these stack up against the justifications for
property?


\defwebsite{dougherty-georgists}{
...
Tensions between property and taxation are longstanding. In the late 1800s,
economist Henry George contended that land ownership was at the heart of a wide
variety of social evils, and proposed a tax on land as a remedy. The Georgist
land value tax idea continues to influence U.S. policy today.
\sentence{dougherty-georgists}. Indeed, you've probably encountered the idea in
an unexpected way. In 1902, Elizabeth Magie created a board game intended to
illustrate how one could bankrupt fellow players through land ownership. It
turns out that people enjoyed bankrupting their friends, making the game into
the best-seller we now call Monopoly.
