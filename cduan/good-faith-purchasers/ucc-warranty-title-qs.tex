...
In some cases, the definition of key terms is given elsewhere in the statute,
...
\item \textbf{Mechanics}. This is how the elements work together to produce
legal results, like liability or rights. Any given fact pattern will give you
yes-no answers for each element---either an element is present in the facts, or
