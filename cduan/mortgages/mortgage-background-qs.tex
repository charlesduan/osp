...
bank) the right to receive monthly payments.
...
You can, and should, notate these using the charts presented in
\mref{narrative-estates-working}.
Say that O owns a house in fee simple absolute, O
...
\end{tabular}
\end{center}
You can draw a similar chart for the interests relating to the promissory note.
In the above chart, ``Mortgagor'' is a possessory estate. As with other
possessory estates, you need to know what event causes it to end. ``Mortgagee''
is a future interest. As with other future interests, you need to know what
possessory estate it follows and what property right it becomes by operation of
law. Can you answer all of these questions?
...
mortgagors.\having{levitin-securitization-foreclosure}{}{}{ Typically, the
