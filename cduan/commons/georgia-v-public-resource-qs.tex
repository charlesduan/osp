...
For legislation, the Government Printing Office publishes statutes, in the order
...
enacted some of the titles of the \emph{U.S. Code} into positive law.} The
\emph{U.S. Code Annotated} and \emph{U.S. Code Service} are independent,
privately published books by West and LexisNexis, respectively, which happen to
...
the case of the Supreme Court, just on its website). A ``reporter'' collects
