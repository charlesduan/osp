...
and negative easements. An \term{affirmative easement} lets the owner do
something on (or affecting) the land of another, known as the \term{servient
estate} (or \term{servient tenement}). The right is the \term{benefit} of
the easement, and the obligation on the servient estate is its \term{burden}.


As noted above, a common affirmative easement is an \term{easement of access}
(also known as an \term{easement of way}), which requires the owner of the
...
is called a \emph{profit \`a prendre} or \term{profit}. Profits were
...
kind of easement. \S~1.2.} A \term{negative easement} prohibits the owner of
...
Another distinction is between the \term{easement appurtenant} and
\term{easement in gross}. An easement appurtenant benefits another piece of
land, the \term{dominant estate}. The owner of the dominant estate exercises
...
Easements are part of the larger law of \term[servitude]{servitudes}, which
include real
covenants and equitable servitudes.  A servitude is a legal device that creates
a right or obligation that \term[run with the land]{runs with the land}. A right
runs with the
