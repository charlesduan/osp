...
\item The common-law baseline is \withterm{nemo dat}{\emph{nemo dat}}{\term[nemo
dat]{nemo dat quod non habet}}: no man can
...
\term{void title} from merely \term{voidable title}:
