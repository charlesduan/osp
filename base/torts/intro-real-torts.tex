The name of the most familiar tort protecting real property, \term{trespass},
...
ejection from his term,'' and often simply ``\term{ejectment}''), protected
...
elbowing each other off the land. The action to \term{quiet title} provides a
...
Originally, the assize of \term{nuisance} protected plaintiffs' rights to use
