...
that, the modern tort of \term{conversion} or \term{trover} took shape: the
...
\term{trespass to chattels}, which evolved from the original action for
...
A final member of the property torts family is \term{replevin}. Initially, it
