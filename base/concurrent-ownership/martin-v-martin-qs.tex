...
Evelyn Lewis concludes that, as with \useterm{adverse possession}, the standard
for what
...
\item \textbf{Accounting: the right to share in profits}.
...
If one cotenant buys the property at a tax sale or a foreclosure sale, the
...
its value, other cotenants may have claims for \term{waste}. While the ordinary
