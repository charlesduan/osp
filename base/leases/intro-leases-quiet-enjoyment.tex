...
commercial, contains a \term{covenant of quiet enjoyment}.  Often this
...
tenant to consider the lease terminated, leave, and stop paying rent.
\having{intro-leases-delivery}{Recall from \mref{intro-leases-delivery} that
the}{In \mref{intro-leases-delivery}, we will see that the}{The} landlord's
