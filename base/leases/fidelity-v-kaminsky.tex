...
n.w.h.).\edfootnote{Texas courts follow state-specific citation rules of the
\emph{Greenbook}, published by the Texas Law Review. Among other things,
citations to Texas appellate decisions must contain an indication of subsequent
case history at the Texas Supreme Court. Here, ``n.w.h.'' means ``no writ
history.''},  Texas law relieves the tenant of contractual liability for any
...
Verplanck}, 31 S.W. 242 (Tex. Civ. App. 1895, no writ). These cases all state
the
