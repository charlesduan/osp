...
The \term{term of years} is a leasehold measured by any fixed period of time. 
...
The \term{periodic tenancy} is a lease for some fixed duration that
...
The \term{tenancy at will} has no fixed duration and endures so long as both
