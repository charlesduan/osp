...
cannot. Trusts can also be \term{inter vivos}, i.e. established by the settlor
during her lifetime, or testamentary, i.e. created in the settlor's will.



\item The basic duties of a trustee are \term{obedience} to the instructions
given by the settlor, \term{loyalty} to the interests of the beneficiaries
(rather than the trustee's own interests), and \term{prudence} in managing the
trust assets appropriately. Various subsidiary duties, such as the duty to
\term[accounting]{account}
...
Observe that the restitutionary remedy involves a kind of \term{tracing}: the
...
\useterm{Rule Against Perpetuities} to attract long-lived dynastic trusts with
