...
\opinion \textsc{Lourie}, Circuit Judge.
...
pieces'' equivalent to the king pieces in chess. \emph{See} '242 patent col.2
...
within a square. \emph{Id.} col.3 ll.21-24; col.8 l.49-col.9 l.12. After moving
or
...
from the game. \emph{Id.} col.3 ll.26-30; col.9 ll.13-17. To win the game, a
player
must direct his laser beam to strike, or illuminate, his opponent's
non-mirrored key playing piece, ending the game. \emph{Id.} col.3 ll.17-20;
col.6
ll.44-47.
...
formations and layouts.'' \emph{Id.} at 647 n.18. The court reasoned that even
if
``the instructions to Laser Battle suggest that its key pieces, the Towers, are
not supposed to be moved during game play,'' they ``are capable of
movement\ldots
...
to place the Tower in for the start of game play.'' \emph{Id.} at 646-47. The
court
also observed that although the instructions to Laser Battle note that ``[t]he
Towers should always remain in their original positions on the board,''
\emph{id.} at
...
formations,'' \emph{see id.} at 647 n.18 \& 19; J.A. 1986. This instruction
suggests
...
nonobviousness. \emph{Id.} at 655. The court first found that the Laser Chess
references were non-analogous art because they described electronic, rather
than real-world, laser games. \emph{Id.} at 653. The district court then held
that,
...
the basis of what would have been obvious to a layperson. \emph{Id.} at 654. The
court
...
prima facie case of obviousness. \emph{Id.}
...
Association's 2007 Game of the Year award. \emph{Id.} at 654-55. In light of its
...
substantial equivalent. \emph{Cybor Corp. v. FAS Techs., Inc.}, 138 F.3d 1448,
1454
...
analysis, and we affirm the district court's decision holding
...
movable from space to space or by rotation within a single space.
\emph{Innovention Toys}, 665 F. Supp. 2d at 642-43. Rather, the court embraced a
definition that
...
and can also be moved during game play.'' \emph{Id.} at 644; \emph{see also id.}
at 644
n.15. Thus, the court's construction of ``movable'' includes the capability of
...
\readinghead{II. Obviousness}

Under the Patent Act, ``[a] patent may not be obtained\ldots if the differences
...
failure of others. \emph{Graham v. John Deere Co.}, 383 U.S. 1, 17-18
(1966). A patent is presumed valid, 35 U.S.C. {\S} 282, and
this
presumption can be overcome only by clear and convincing evidence to the
contrary. \emph{Bristol-Myers Squibb Co. v. Ben Venue Labs., Inc.}, 246 F.3d
1368,
1374 (Fed. Cir. 2001).
...
\readinghead{\textit{A. Analogous Art}}

A reference qualifies as prior art for a determination under {\S} 103 when it is
analogous to the claimed invention. \emph{In re Clay}, 966 F.2d 656, 658
...
problem with which the inventor is involved.'' \emph{In re Bigio}, 381
F.3d 1320, 1325
(Fed. Cir. 2004). {\dots}
...
since each discloses ``an electronic version of the '242 patent.''
\emph{Innovention
...
references to be analogous art based on this test as a matter of law. \emph{See
Wyers
v. Master Lock Co.}, 616 F.3d 1231, 1238 (Fed. Cir. 2010) (holding as a matter
of law that prior art padlock seals were analogous since directed to the same
...
types of playing pieces, \emph{id.} col.6 l.48--col.7 l.24; (2) the game's
specific
rules, including how the pieces may move on the game board during a player's
turn, \emph{id.} col.3 ll.21--28, col.8 l.49--col.9 l.17; and (3) the game's
ultimate
objective, namely, illuminating an opponent's key playing piece with a laser
beam, \emph{id.} col.6 ll.45-47. The specification even distinguishes prior art
patents based on these game elements, stating that U.S. Patent 3,516,671 lacks
``the unique elements and rules of the ['242 patent's] invention,'' \emph{id.}
col.1
...
to flank (or surround) those of the opposing player,'' \emph{id.} col.2
ll.16-21.
...
manner, and quickly become uninteresting for the average player.'' \emph{Id.}
col.2
...
and uninteresting for the average player.'' \emph{Id.} col.2 ll.57-60.
...
itself to an inventor's attention in considering [this] problem.'' \emph{Clay},
966
...
their strategy games in both physical and electronic formats. \emph{Innovention
Toys},
...
modifications of the game allow for\ldots a single player playing against a
...
references with the Swift patent in light of the standard articulated in
\emph{KSR
International Co. v. Teleflex, Inc.}, 550 U.S. 398
(2007). We therefore remand these factual determinations to the district
...
whether Innovention's secondary considerations overcome MGA's prima facie
case.\dots

\readinghead{III. Permanent Injunction}
...
nonobviousness, we also vacate the district court's permanent injunction.\ldots
