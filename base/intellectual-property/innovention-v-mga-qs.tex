...
\textit{Novelty}. An invention must be \textit{novel} in an absolute
...
for the Supreme Court in \textit{KSR Intern. Co. v. Teleflex, Inc.}, 550 U.S.
398, 427 (2007):
\begin{quote}
...
different from the substantial-similiarity and fair-use tests in copyright law?
...
\item The patent equivalent to first sale is the doctrine of \textit{exhaustion}:
...
\textit{Bowman v. Monsanto Co.}, 569 U.S. 278 (2013), Monsanto owned a
...
other other farmers' harvests. The Supreme Court unanimiously held that Bowman
