...
added).\readingfootnote{7}{Regrettably, the rhetorical force of our
...
the tract as a whole. (For an extreme---and, we think, unsupportable---view of
...
elimination of) value. In any event, we avoid this difficulty in the present
...
We have never set forth the justification for this rule. Perhaps it is simply,
...
taking.\readingfootnote{8}{Justice \textsc{Stevens} criticizes the ``deprivation
...
Transportation Co. v. New York City}, 438 U.S. 104, 124 (1978). It is true that
...
\textit{any} competing adjacent use must yield.\readingfootnote{12}{In Justice
